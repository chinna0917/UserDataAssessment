...
void BuildApiData()
{
	...
	std::string apiResponse = GetApiData("https://dummyapi.io/data/v1/user?limit=2");
...
void ImgeShow(const std::string &id)
{
	...
	if (it != userData.end())
	{
		...
		cv::putText(img, "Name :" + val.fName+" "+val.lName, cv::Point(270, 350), cv::FONT_HERSHEY_COMPLEX, 1.0, cv::Scalar(200, 10,10), 1);
		cv::putText(img, "ID :" + it->first, cv::Point(270, 380), cv::FONT_HERSHEY_COMPLEX, 1.0, cv::Scalar(200, 10, 10), 1);


		cv::putText(img, "Gender :"+ val.genter, cv::Point(10, 30), cv::FONT_HERSHEY_SIMPLEX, 1.0, cv::Scalar(0, 0, 0), 1);
		cv::putText(img, "Date of birth :"+ val.dob, cv::Point(10, 50), cv::FONT_HERSHEY_SIMPLEX, 1.0, cv::Scalar(0, 0, 0), 1);
		cv::putText(img, "Register date:  :"+ val.regDate, cv::Point(10, 70), cv::FONT_HERSHEY_SIMPLEX, 1.0, cv::Scalar(0, 0, 0), 1);
		cv::putText(img, "Email :"+ val.email, cv::Point(10, 90), cv::FONT_HERSHEY_COMPLEX, 1.0, cv::Scalar(0, 0, 0), 1);
		cv::putText(img, "Phone :"+ val.mbl, cv::Point(10, 110), cv::FONT_HERSHEY_COMPLEX, 1.0, cv::Scalar(0, 0, 0), 1);
		cv::putText(img, "Address :", cv::Point(10, 160), cv::FONT_HERSHEY_COMPLEX, 1.0, cv::Scalar(0, 0, 0), 1);
		cv::putText(img, "State :" + val.loc.state, cv::Point(10, 180), cv::FONT_HERSHEY_COMPLEX, 1.0, cv::Scalar(0, 0, 0), 1);
		cv::putText(img, "Street :" + val.loc.street, cv::Point(10, 200), cv::FONT_HERSHEY_COMPLEX, 1.0, cv::Scalar(0, 0, 0), 1);
		cv::putText(img, "City :" + val.loc.city, cv::Point(10, 220), cv::FONT_HERSHEY_COMPLEX, 1.0, cv::Scalar(0, 0, 0), 1);
		cv::putText(img, "Country :" + val.loc.country, cv::Point(10, 240), cv::FONT_HERSHEY_COMPLEX, 1.0, cv::Scalar(0, 0, 0), 1);
		cv::putText(img, "Timezone :" + val.loc.timezone, cv::Point(10, 260), cv::FONT_HERSHEY_COMPLEX, 1.0, cv::Scalar(0, 0, 0), 1);
		...
		//cv::Mat ma(72,72, CV_8UC3, pic.data());
		std::vector<byte> vectordata(pic.begin(), pic.end());
		//cv::Mat data_mat(72, 72, CV_8UC3, vectordata);
//		cv::Mat data_mat(72, 72, CV_8UC3, const_cast<char*>(pic.c_str()));
		//cv::Mat data_mat = cv::imread("C:\\Users\\chinn\\Downloads\\aadhaar_front.jpg",-1);
		...
		Mat insetImage(img, Rect(20, 350, 100, 100));
